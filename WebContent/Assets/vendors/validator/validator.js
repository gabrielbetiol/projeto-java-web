...
var validator = (function($){
    ...
    */
    message = {
        ...
        empty           : 'campo em branco',
        min             : 'entrada muita curta',
        max             : 'entrada muito longa',
        number_min      : 'too low',
        number_max      : 'too high',
        url             : 'invalid URL',
        number          : 'digite um valor numerico',
        email           : 'e-mail invalido',
        email_repeat    : 'e-mails diferentes',
        password_repeat : 'senhas diferentes',
        repeat          : 'não corresponde',
